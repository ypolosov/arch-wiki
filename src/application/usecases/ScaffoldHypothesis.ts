 ...
 * frontmatter, then auto-add a kanban backlog card so the page is not an orphan
 * (fix #2: kanban `[[..]]` links count as inbound even though kanban is structural).
 * Deterministic; reuses the single scaffold path (§4.0).
 */
